...
export default function Dashboard() {
    ...
    return (_jsxs(_Fragment, { children: [_jsx("h3", { className: "mb-4", children: "Dashboard" }), _jsxs("h5", { className: "text-muted", children: ["Today (", data.today, ")"] }), _jsx(Row, { className: "g-3 mb-4", children: TODAY_TILES.map(({ key, label }) => (_jsx(Col, { md: 4, children: _jsx(ProgressTile, { label: label, count: m[key].today ?? 0, goal: m[key].daily }) }, `today-${key}`))) }), _jsxs("h5", { className: "text-muted", children: ["This week (since ", data.week_start, ")"] }), _jsx(Row, { className: "g-3 mb-4", children: TODAY_TILES.map(({ key, label }) => (_jsx(Col, { md: 4, children: _jsx(ProgressTile, { label: label, count: m[key].week ?? 0, goal: m[key].weekly }) }, `week-${key}`))) }), _jsxs(Row, { className: "g-3", children: [_jsx(Col, { md: 8, children: _jsx(Card, { children: _jsxs(Card.Body, { children: [_jsx(Card.Title, { children: "Recent activity" }), data.recent_submissions.length === 0 ? (_jsx(Card.Text, { className: "text-muted mb-0", children: "No activity yet \u2014 submissions and responses will appear here." })) : (_jsx("ul", { className: "list-unstyled mb-0", children: data.recent_submissions.map((s) => (_jsxs("li", { className: "py-2 border-bottom d-flex align-items-center", children: [_jsx("span", { className: "me-2", children: _jsx(StatusBadge, { status: s.status }) }), _jsx(Link, { to: `/submissions/${s.id}`, className: "me-2", children: s.role_title ?? '(untitled)' }), _jsx("span", { className: "text-muted me-2", children: s.company_name ? `at ${s.company_name}` : '' }), _jsx("span", { className: "ms-auto text-muted small", children: s.submitted_on ?? '' })] }, s.id))) }))] }) }) }), _jsx(Col, { md: 4, children: _jsx(Card, { children: _jsxs(Card.Body, { children: [_jsx(Card.Title, { children: "Pending follow-ups" }), _jsx("div", { className: "fs-3 fw-semibold", children: m.follow_ups.pending ?? 0 }), _jsx(Card.Text, { className: "text-muted mb-0", children: "Submissions awaiting a follow-up." })] }) }) })] })] }));
}
